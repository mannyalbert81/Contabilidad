...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Reporte Recaudacion- contabilidad 2016</title>
	...
	function load_recaudacion(pagina){
		//iniciar variables
		...
		$("#recaudacion").fadeIn('slow');
		$.ajax({
			url:"<?php echo $helper->url("ReporteRecaudacion","index");?>",
            type : "POST",
            async: true,			
			data: con_datos,
			 beforeSend: function(objeto){
			$("#recaudacion").html('<img src="view/images/ajax-loader.gif"> Cargando...');
			},
			success:function(data){
				$(".div_recaudacion").html(data).fadeIn('slow');
				$("#recaudacion").html("");
			}
		})
	}
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("ReporteRecaudacion","index"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12" target="_blank">
         
         <!-- comienxza busqueda  -->
         <div class="col-lg-12" style="margin-top: 10px">
         
       	 <h4 style="color:#ec971f;">Reporte Recaudacion</h4>
	  ...
	  <!-- 
       ...
       <?php } else {?>
		 ...
		 <h4 style="color:#ec971f;"></h4>
			  <div>					
					<div id="recaudacion" style="position: absolute;	text-align: center;	top: 10px;	width: 100%;display:none;"></div><!-- Carga gif animado -->
					<div class="div_recaudacion" >
