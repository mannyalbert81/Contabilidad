                  ...
                  <table class="table table-hover">
					...
					while($row = pg_fetch_array($query)){
						...
						<tr>
							...
							<a href="index.php?controller=Comprobantes&action=ReporteEgresos&id_ccomprobantes=<?php echo $id_ccomprobantes; ?>" target="_blank"><i class="glyphicon glyphicon-print"></i></a>
							</span>
							</td>
