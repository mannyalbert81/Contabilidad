...
class BalanceComprobacionAdmController extends ControladorBase{
	...
	public function BalanceComprobacionAdm(){
	   ...
	   $cuenta_cierre_mes = new CuentasCierreMesModel();
		...
		if (isset(  $_SESSION['usuario_usuarios']) )
		{
			...
			$nombre_controladores = "BalanceComprobacionAdm";
			...
			$this->view("BalanceComprobacionAdm",array(
					"resultSet"=>$resultSet,
					"resultEnt"=>$resultEnt
